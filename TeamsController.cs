...
namespace VacationManager.Controllers
{
    ...
    public class TeamsController : Controller
    {
        ...
        {
            // 1. Ръчни проверки (ако моделът не ги хваща автоматично)
            ...
            // 2. Проверка на ModelState преди запис
            if (ModelState.IsValid)
            {
                // ЗАПИСВАМЕ САМО ВЕДНЪЖ
                _context.Teams.Add(team);
                await _context.SaveChangesAsync();

                // 3. Актуализираме TeamId на лидера, ако съществува
            ...
            // 4. Ако моделът не е валиден, презареждаме SelectList-овете и връщаме View-то
